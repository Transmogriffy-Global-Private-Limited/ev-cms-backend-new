...
func RegisterCPORoutes(
	...
	operationsAndManage := group.Group("", auth.RequireCPOPermission(service.database, cpopermissions.ChargersOperations), auth.RequireCPOPermission(service.database, cpopermissions.ChargersManage))
	...
	operations.POST("/operations/chargers/:charger_id/reset", handler.resetCharger)
	operations.POST("/operations/chargers/:charger_id/unlock", handler.unlockConnector)
	operations.POST("/operations/chargers/:charger_id/availability", handler.changeAvailability)
	...
	operations.POST("/operations/chargers/:charger_id/configuration/read", handler.readChargerConfiguration)
	...
	operations.GET("/operations/charger-operations/:operation_id/ocpp-exchanges", handler.getChargerOperationOCPPExchanges)
