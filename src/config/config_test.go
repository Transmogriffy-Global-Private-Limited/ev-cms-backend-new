...
func validTestConfig() Config {
	return Config{
		...
		Frontend: FrontendLinks{
			...
			CPOCustomerSupportTicketTemplate: "https://cms.example.invalid/customer-support/tickets/{ticket_id}",
			CustomerSupportTicketTemplate:    "https://app.example.invalid/support/tickets/{ticket_id}",
