...
func TestCredentialRoutesAreRegisteredAndProtected(t *testing.T) {
	...
	protected := []struct {
		...
		{http.MethodPost, "/api/v1/cpo/hub-tariffs"},
		{http.MethodGet, "/api/v1/cpo/hub-tariffs"},
		{http.MethodGet, "/api/v1/cpo/hub-tariffs/00000000-0000-0000-0000-000000000001"},
		{http.MethodPatch, "/api/v1/cpo/hub-tariffs/00000000-0000-0000-0000-000000000001"},
		{http.MethodPost, "/api/v1/cpo/user-group-tariffs"},
		{http.MethodGet, "/api/v1/cpo/user-group-tariffs"},
		{http.MethodGet, "/api/v1/cpo/user-group-tariffs/00000000-0000-0000-0000-000000000001"},
		{http.MethodPatch, "/api/v1/cpo/user-group-tariffs/00000000-0000-0000-0000-000000000001"},
