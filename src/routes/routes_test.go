...
func TestCredentialRoutesAreRegisteredAndProtected(t *testing.T) {
	...
	protected := []struct {
		...
		{http.MethodPatch, "/api/v1/app/auth/profile"},
		{http.MethodGet, "/api/v1/app/auth/hubs"},
		{http.MethodGet, "/api/v1/app/auth/hubs/00000000-0000-0000-0000-000000000001"},
		{http.MethodGet, "/api/v1/app/auth/hubs/00000000-0000-0000-0000-000000000001/price"},
		{http.MethodGet, "/api/v1/app/auth/chargers"},
		{http.MethodGet, "/api/v1/app/auth/chargers/abc123"},
		...
		{http.MethodPut, "/api/v1/app/auth/favorite-chargers/abc123"},
		{http.MethodDelete, "/api/v1/app/auth/favorite-chargers/abc123"},
