...
type Tariff struct {
	...
	TariffType    constants.TariffType `gorm:"type:tariff_type" json:"tariff_type"`
	PriceType     constants.PriceType  `gorm:"type:price_type" json:"price_type"`
	Units         constants.Unit       `gorm:"type:units" json:"units"`
	CreatedAt     time.Time            `gorm:"not null" json:"created_at"`
	UpdatedAt     time.Time            `gorm:"not null" json:"updated_at"`
}
