...
func RegisterRoutes(group *gin.RouterGroup, service *Service) {
	...
	protected.GET("/vehicles", handler.listVehicles)
	protected.GET("/vehicles/:vehicle_id", handler.getVehicle)
	protected.PATCH("/vehicles/:vehicle_id", handler.updateVehicle)
	protected.DELETE("/vehicles/:vehicle_id", handler.deleteVehicle)
