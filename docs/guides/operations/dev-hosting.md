...
revision `b79a3e5` (CPO typed charger operations). It has migrations one
through sixty-one and the current 232-operation API. The binary
SHA-256 is
...
currently deployed `b79a3e5` binary includes this logger. The stale prior
binary is retained at
`/root/evcmsnew-backups/pre-b79a3e5-20260904T110619+0530/evcmsnew`
(SHA-256 `9193f1986dfc1df91862a4eb01769d897dfef7f82f10a218eb99b796703c5253`).
