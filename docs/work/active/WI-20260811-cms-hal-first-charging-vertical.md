...
- The current shared development deployment is clean source revision
  `d475b41` with migrations through thirty-nine and 180 OpenAPI operations.
...
- Migration `000028_cms_hal_charging_vertical` and migration
  ...
  also applied. The current deployment is runtime revision `d475b41` as recorded above.
